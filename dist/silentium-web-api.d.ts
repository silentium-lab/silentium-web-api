...
import { MessageType, MaybeMessage } from 'silentium';
 ...
 */
declare function FetchedData($request: MessageType<Partial<FetchRequestType>>, $abort?: MessageType): silentium.MessageImpl<string>;

/**
 * Represents a request for JSON data.
 */
declare function RequestJson($request: MessageType<Partial<FetchRequestType>>): silentium.MessageImpl<Partial<FetchRequestType>>;

/**
 * Represents a collection of elements that match a given CSS selector.
 */
declare function Elements<T extends HTMLElement>(_selector: MaybeMessage<string>): silentium.MessageImpl<T[]>;
 ...
 */
declare function Element<T extends HTMLElement>(_selector: MaybeMessage<string>): silentium.MessageImpl<T>;
